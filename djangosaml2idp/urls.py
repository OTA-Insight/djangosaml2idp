...
urlpatterns = [
    ...
    path('login/process_multi_factor/', views.get_metadata, name='saml_multi_factor'),
    path('login/process_user_agreement/', views.UserAgreementScreen.as_view(), name='saml_user_agreement'),
